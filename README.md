...
دقت داشته باشید میتونید رنج ای پی وارد کنید
ای پی های ورودی باید توی فایل ip-in قرار بگیرن 
کانفیگ vless شخصی خودتون که از کار کردنش مطمئنید رو توی فایل config قرار بدید به جای کانفیگ پیش فرض
